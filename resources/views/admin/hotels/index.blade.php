        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Prix/Nuit</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">#{{ $hotel->id }}</td>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900 font-medium">{{ number_format($hotel->price_per_night, 0, ',', ' ') }} €</td>
                    <td class="px-6 py-4">
